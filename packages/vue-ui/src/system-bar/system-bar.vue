  ...
  >
    <div class="ky-system-bar__inner">
      <button
        ...
        @click="$emit('back')"
      >
        <KyIcon source="iconfont" name="arrow-left" :size="24" />
      </button>
...
// 顶部安全区通过 env() Token 处理，三列网格确保标题保持视觉居中。
withDefaults(defineProps<SystemBarProps>(), { theme: 'light', showBack: true, safeTop: true });
defineEmits<{ back: [] }>();
</script>
